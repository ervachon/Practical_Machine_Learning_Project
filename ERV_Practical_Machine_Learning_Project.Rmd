...
First we are going to remove timestamp feature.
```{r,message=FALSE, warning=FALSE}
...
Next we removed the feature with more than 95% of NA or null string ('') (not relevant because not have much prediction power).
```{r,message=FALSE, warning=FALSE}
